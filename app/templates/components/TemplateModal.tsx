...
export default function TemplateModal({ template, onClose }: TemplateModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden">        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div className="flex items-center space-x-1">
                  ...
                  {template.price === 'Free' ? 'Miễn Phí' : 'Cao Cấp'}
                </span>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 mb-6">
                ...
                <h4 className="text-lg font-semibold text-gray-900 mb-3">Thẻ</h4>
